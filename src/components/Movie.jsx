...
const Movie = () => {
    ...
    document.title = "Akshat | movie "+ category.toUpperCase();
    ...
    const Getmovie = async () => {
        try {
            ...
            if (data.results.length > 0) {
                setMovie((prevState) => [...prevState, ...data.results]); // Append new results to existing ones
        ...
        <div className='w-full h-screen bg-gradient-to-br from-[#1f1e24] via-[#252229] to-[#1f1e24]'>
            <div className='px-[3%] w-full flex items-center justify-between mb-5 pt-4 relative z-50'>  
                <h1 className='text-2xl text-zinc-300 font-semibold flex items-center'>  
                    ...
                    <span className="bg-gradient-to-r from-[#6556CD] to-[#8b5cf6] bg-clip-text text-transparent">🔥 Movie({category})</span>
                </h1>
